...
var recheckFor = map[string][]string{
	...
	"maldet-deps-unit":     {"maldet", "systemd.failed"},
	"quotacheck-reset":     {"systemd.failed"},
	"web-terminal-update":  {"systemd.failed"},
	"redis-own-db":         {"redis.sites", "redis"},
	"redis-maxttl":         {"redis.sites", "redis"},
	"redis-maxttl-all":     {"redis.sites", "redis"},
	"redis-no-selective":   {"redis.sites"},
	"redis-dropin":         {"redis.sites"},
	"redis-group-flush":    {"redis.sites", "redis"},
	"redis-lazyfree":       {"redis"},
	"redis-databases":      {"redis.sites"},
